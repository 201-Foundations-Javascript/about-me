...
function Welcome() {
    var userWelcome = prompt('Welcome to my guessing game page where you get to test your knowledge of knwing me. What is your name?')
    alert('Welcome and goodluck ' + userWelcome);
}
function Question1() {
